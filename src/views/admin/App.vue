...
import VisualSummaryPanel from '@/components/bilan/VisualSummaryPanel.vue';

const currentView = ref<'list' | 'details'>('list');
const selectedResidence = ref<string | null>(null);
const canEdit = ref(true);

const handleSelectResidence = (residenceId: string) => {
  selectedResidence.value = residenceId;
...
<template>
  <div class="app">
    <header v-if="currentView === 'details'" class="app-header">
      <div class="container">
    ...
    <main class="app-main">
      ...
      <div v-else-if="currentView === 'details' && selectedResidence" class="container">
        <VisualSummaryPanel
